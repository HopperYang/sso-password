...
const BANK_PIN_URL = "http://localhost:5173/bank/pin?embed=1";
...
document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
  <main class="vendor">
    ...
    <p class="lead">
      ...
      （<code>5173</code>）；父页面脚本无法跨源读取 iframe 内密码框内容。
    </p>
    <p class="hint">
      请先启动：<code>sso-server</code>（8080）与 <code>poc-web</code>（5173）。本目录仅提供壳页，不代理 API。
    </p>
